...
(function($, window, document, undefined) {
    ...
    $.widget("toc.tocify", {
        ...
        _nestElements: function(self, index) {
            ...
            if(self.is('.api-property--property')) {
                className += ' tocify-item--api-property';
            }
            if(self.is('.api-property--method')) {
                className += ' tocify-item--api-method';
            }
            if(self.is('.api-property--inherited')) {
                className += ' tocify-item--api-inherited';
            }
            if(self.is('.api-property--deprecated')) {
                className += ' tocify-item--api-deprecated';
            }
            ...
            if(self.is('.divider')) {
                ...
                newEl.find('.api-property__inherited, .api-property__args, .api-property__type').remove();
                var text = newEl.text();
                ...
                item.append($("<a/>", {text}).attr('href', '#'+hashValue));
            }
